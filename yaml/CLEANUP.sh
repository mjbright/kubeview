...
RUN kubectl delete -f ./3-DEMO_SERVICES/flask-service.yaml
...
RUN kubectl delete -f ./3-DEMO_SERVICES/redis-service.yaml
RUN kubectl delete -f ./0-DEMO_BASIC/redis-deployment.yaml

RUN kubectl delete -n test0 -f ./3-DEMO_SERVICES/flask-service.yaml
RUN kubectl delete -n test0 -f ./3-DEMO_SERVICES/redis-service.yaml
...
./2-DEMO_UPGRADE
./2-DEMO_UPGRADE/flask-deployment.yaml.r4.v2.yaml
./2-DEMO_UPGRADE/flask-deployment.yaml.r4.v3.yaml
./2-DEMO_UPGRADE/flask-deployment.yaml.r4.v4.yaml
./2-DEMO_UPGRADE/flask-deployment.yaml.r4.v5.yaml
./3-DEMO_SERVICES
./3-DEMO_SERVICES/flask-service.yaml
./3-DEMO_SERVICES/redis-service.yaml
./CLEANUP.sh
